...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang bpf program.bpf.c -- -I./headers
...
func main() {
	...
	tpI, err := link.Tracepoint("syscalls", "sys_exit_execve", objs.IgExecveX, nil)
	if err != nil {
